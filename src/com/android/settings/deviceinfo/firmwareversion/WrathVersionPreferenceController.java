...
public class WrathVersionPreferenceController extends BasePreferenceController {

    private static final String TAG = "wrathVersionDialogCtrl";
    private static final int DELAY_TIMER_MILLIS = 500;
    private static final int ACTIVITY_TRIGGER_COUNT = 3;

    private static final String KEY_WRATH_VERSION_PROP = "ro.wrath.base.version";
    ...
    public WrathVersionPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public void copy() {
        Sliceable.setCopyContent(mContext, getSummary(),
                mContext.getText(R.string.wrath_version));
    }
}
